...
/*   Updated: 2019/05/28 16:52:27 by qloubier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_v3d				inv3d(t_v3d a);
t_v3d				*invp3d(t_v3d *a);

/*
** t_v4i tool
*/

t_v4i				v4iaddv4i(t_v4i a, t_v4i b);
t_v4i				v4iaddv4f(t_v4i a, t_v4f b);
t_v4i				v4iaddv4d(t_v4i a, t_v4d b);
t_v4i				*pv4iaddv4i(t_v4i *a, const t_v4i b);
t_v4i				*pv4iaddv4f(t_v4i *a, const t_v4f b);
t_v4i				*pv4iaddv4d(t_v4i *a, const t_v4d b);

t_v4i				v4isubv4i(t_v4i a, t_v4i b);
t_v4i				v4isubv4f(t_v4i a, t_v4f b);
t_v4i				v4isubv4d(t_v4i a, t_v4d b);
t_v4i				*pv4isubv4i(t_v4i *a, const t_v4i b);
t_v4i				*pv4isubv4f(t_v4i *a, const t_v4f b);
t_v4i				*pv4isubv4d(t_v4i *a, const t_v4d b);

t_v4i				v4imulv4i(t_v4i a, t_v4i b);
t_v4i				v4imulv4f(t_v4i a, t_v4f b);
t_v4i				v4imulv4d(t_v4i a, t_v4d b);
t_v4i				*pv4imulv4i(t_v4i *a, const t_v4i b);
t_v4i				*pv4imulv4f(t_v4i *a, const t_v4f b);
t_v4i				*pv4imulv4d(t_v4i *a, const t_v4d b);

t_v4i				v4idivv4i(t_v4i a, t_v4i b);
t_v4i				v4idivv4f(t_v4i a, t_v4f b);
t_v4i				v4idivv4d(t_v4i a, t_v4d b);
t_v4i				*pv4idivv4i(t_v4i *a, const t_v4i b);
t_v4i				*pv4idivv4f(t_v4i *a, const t_v4f b);
t_v4i				*pv4idivv4d(t_v4i *a, const t_v4d b);

t_v4i				inv4i(t_v4i a);
t_v4i				*invp4i(t_v4i *a);
...
t_v4f				inv4f(t_v4f a);
t_v4f				*invp4f(t_v4f *a);

/*
** t_v4d tool
*/

t_v4d				v4daddv4i(t_v4d a, t_v4i b);
t_v4d				v4daddv4f(t_v4d a, t_v4f b);
t_v4d				v4daddv4d(t_v4d a, t_v4d b);
t_v4d				*pv4daddv4i(t_v4d *a, const t_v4i b);
t_v4d				*pv4daddv4f(t_v4d *a, const t_v4f b);
t_v4d				*pv4daddv4d(t_v4d *a, const t_v4d b);

t_v4d				v4dsubv4i(t_v4d a, t_v4i b);
t_v4d				v4dsubv4f(t_v4d a, t_v4f b);
t_v4d				v4dsubv4d(t_v4d a, t_v4d b);
t_v4d				*pv4dsubv4i(t_v4d *a, const t_v4i b);
t_v4d				*pv4dsubv4f(t_v4d *a, const t_v4f b);
t_v4d				*pv4dsubv4d(t_v4d *a, const t_v4d b);

t_v4d				v4dmulv4i(t_v4d a, t_v4i b);
t_v4d				v4dmulv4f(t_v4d a, t_v4f b);
t_v4d				v4dmulv4d(t_v4d a, t_v4d b);
t_v4d				*pv4dmulv4i(t_v4d *a, const t_v4i b);
t_v4d				*pv4dmulv4f(t_v4d *a, const t_v4f b);
t_v4d				*pv4dmulv4d(t_v4d *a, const t_v4d b);

t_v4d				v4ddivv4i(t_v4d a, t_v4i b);
t_v4d				v4ddivv4f(t_v4d a, t_v4f b);
t_v4d				v4ddivv4d(t_v4d a, t_v4d b);
t_v4d				*pv4ddivv4i(t_v4d *a, const t_v4i b);
t_v4d				*pv4ddivv4f(t_v4d *a, const t_v4f b);
...
t_v4d				v4dcrossv4f(const t_v4d a, const t_v4f b);
t_v4d				v4dcrossv4d(const t_v4d a, const t_v4d b);
t_v4d				*pv4dcrossv4f(t_v4d *v, const t_v4f b);
t_v4d				*pv4dcrossv4d(t_v4d *v, const t_v4d b);

t_v4d				inv4d(t_v4d a);
t_v4d				*invp4d(t_v4d *a);
